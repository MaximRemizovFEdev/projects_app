...
export const CVForm = () => {
    ...
    return (
        <div>
            ...
            <hr/>
            <h3>Вопросы работодателю</h3>
            <ul className="text-width">
                <li>
                    О команде и структуре:
                    "Как устроена структура команды, в которой я буду работать?
                    Кто мои непосредственные руководители и коллеги?"
                </li>
                <li>
                    О возможностях обучения и развития:
                    "Предусмотрены ли в компании возможности для обучения 
                    и профессионального развития сотрудников? Есть ли ментор закрепленный?"
                </li>
                <li>
                    О перспективах роста:
                    "Какие возможности для карьерного роста и повышения в компании существуют?"
                </li>
            </ul>
            <hr/>
        </div>
